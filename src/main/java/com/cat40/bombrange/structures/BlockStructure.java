...
public class BlockStructure extends Block 
{
    ...
    public BlockStructure(int id, Material material, String textureName, Structure structure, boolean spawnAir)
    {  
    	super(material);
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
        if (player.getCurrentEquippedItem() != null && player.getCurrentEquippedItem().getItem() == Main.lighter)
        {
            ...
            this.structure.setDir(dir);
            this.structure.spawnStructure(world, x, y, z, this.spawnAir);
