...
public class RenderDelay10 extends Render
{
    private RenderBlocks blockRenderer = new RenderBlocks();
    private static final String __OBFID = "CL_00001030";

    public RenderDelay10()
    {
     ...
     */
    public void doRender(DelayPrime10 p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        GL11.glPushMatrix();
     ...
     */
    protected ResourceLocation getEntityTexture(DelayPrime10 _110775_1_)
    {
    ...
    {
        return this.getEntityTexture((DelayPrime10)p_110775_1_);
    }
    ...
    {
        this.doRender((DelayPrime10)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
}