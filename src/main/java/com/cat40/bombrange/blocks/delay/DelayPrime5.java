...
public class DelayPrime5 extends Entity
{
    /** How long the fuse is */
    public int fuse = 5*20+1;
    private World world;
    private EntityLivingBase tntPlacedBy;
    private double constantPosY;

    public DelayPrime5(World par1World)
    {
        super(par1World);
    ...
    public DelayPrime5(World par1World, double par2, double par4, double par6)//EntityLivingBase par8EntityLivingBase
    {
        this(par1World);
    ...
    private void explode(double y)
    {
        ...
        // TODO: fix explosion spawning at y=0
    }
