...
public class Delay5 extends Block
{
    private String texturePath = Main.modid;  
    private int thisBlockID;
    
    public Delay5 (int id, Material material, String textureName) {
...
*/
    public void primeTnt(World par1World, int par2, int par3, int par4, int par5)
    {
        if (!par1World.isRemote)
        {
            if ((par5 & 1) == 1)
            {
                DelayPrime5 entitytntprimed = new DelayPrime5(par1World, (double)((float)par2 + 0.5F), (double)((float)par3/* + 0.5F/**/), (double)((float)par4 + 0.5));
