...
public class DelayPrime30 extends Entity
{
    /** How long the fuse is */
    public int fuse = 30*20;
    private World world;
    private EntityLivingBase tntPlacedBy;
    private double constantPosY;

    public DelayPrime30(World par1World)
    {
        super(par1World);
    ...
    public DelayPrime30(World par1World, double par2, double par4, double par6)//EntityLivingBase par8EntityLivingBase
    {
        this(par1World);
