...
public class Potion extends Block
{
    ...
    public Potion (int id, Material material, String textureName) {
...
*/
    public void primeTnt(World par1World, int par2, int par3, int par4, int par5)
    {
        if (!par1World.isRemote)
        {
            if ((par5 & 1) == 1)
            {
                PotionPrime entitytntprimed = new PotionPrime(par1World, (double)((float)par2 + 0.5F), (double)((float)par3 + 0.5F), (double)((float)par4 + 0.5));
