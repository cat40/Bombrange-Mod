...
public class PotionPrime extends Entity
{
    ...
    public PotionPrime(World par1World)
    {
        super(par1World);
    ...
    public PotionPrime(World par1World, double par2, double par4, double par6)//EntityLivingBase par8EntityLivingBase
    {
        this(par1World);
        ...
        if (this.fuse-- <= 0)
        {
            ...
            if (!this.worldObj.isRemote)
            {
            	...
            	for(i=0; i<this.rings; i++)
                {
            		...
            		{
	            		EntityPotion entitylargefireball = new EntityPotion(this.worldObj);
