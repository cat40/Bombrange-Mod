...
public class ArrowPrime extends Entity
{
    ...
    private static int arrowNum = 20; //Number of arrows in smallest ring. *arrowNumMultiplier per each subsequent ring
    ...
    public ArrowPrime(World par1World)
    {
        super(par1World);
    ...
    public ArrowPrime(World par1World, double par2, double par4, double par6)//EntityLivingBase par8EntityLivingBase
    {
        this(par1World);
        ...
        if (this.fuse-- <= 0)
        {
            ...
            if (!this.worldObj.isRemote)
            {
            	...
            	for(i=0; i<this.rings; i++)
                {
            		...
            		{
	            		EntityArrow entitylargefireball = new EntityArrow(this.worldObj);
