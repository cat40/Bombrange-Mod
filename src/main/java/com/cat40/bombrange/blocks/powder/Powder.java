...
public class Powder extends Block
{
	...
	int chanceBang = 1001; //1:changeBang-1 chance of exploding
    private String texturePath = Main.modid;  
    private int thisBlockID;
    
    public Powder (int id, Material material, String textureName) {
...
*/
    ...
    public void onBlockAdded(World world, int x, int y, int z)
    {
        ...
        {
        	this.chanceExplode(world, x, y, z);
        }
    }
...
*/
    ...
    public void chanceExplode(World world, int x, int y, int z)
    {
    	if(!Main.bool(rand.nextInt(chanceBang)))
    	{
