package com.cat40.bombrange.blocks.c4.Half;
...
public class C4_Half extends Block
{
    ...
    public C4_Half (int id, Material material, String textureName) 
    {
        super(material);
...
*/
    ...
    public void primeTnt(World par1World, int par2, int par3, int par4, int par5)
    {
        if (!par1World.isRemote)
        {
            if ((par5 & 1) == 1)
            {
                HalfPrime entitytntprimed = new HalfPrime(par1World, (double)((float)par2 + 0.5F), (double)((float)par3 + 0.5F), (double)((float)par4 + 0.5), Main.fuseLen);
...
/*    public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_)
    {
        ...
        this.field_150116_a = p_149651_1_.registerIcon(texturePath + "C4_top");
        this.field_150115_b = p_149651_1_.registerIcon(texturePath + "C4_bottom");
    }
}
