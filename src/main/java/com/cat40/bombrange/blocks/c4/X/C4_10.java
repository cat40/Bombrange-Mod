package com.cat40.bombrange.blocks.c4.X;
...
public class C4_10 extends Block
{
    ...
    public C4_10 (int id, Material material, String textureName)
    {
        super(material);
...
*/
    ...
    public void primeTnt(World par1World, int par2, int par3, int par4, int par5)
    {
        if (!par1World.isRemote)
        {
            if ((par5 & 1) == 1)
            {
                XPrime entitytntprimed = new XPrime(par1World, (double)((float)par2 + 0.5F), (double)((float)par3 + 0.5F), (double)((float)par4 + 0.5), Main.fuseLen);
