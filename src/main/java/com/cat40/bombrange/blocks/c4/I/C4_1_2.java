package com.cat40.bombrange.blocks.c4.I;
...
public class C4_1_2 extends Block
{
    ...
    public C4_1_2 (int id, Material material, String textureName)
    {        
        super(material);
    ...
    public void primeTnt(World par1World, int par2, int par3, int par4, int par5)
    {
        if (!par1World.isRemote)
        {
            if ((par5 & 1) == 1)
            {
            	/*for(int a = 1*4; a>0; a--)
            	{
            		QuartPrime entitytntprimed = new QuartPrime(par1World, (double)((float)par2 + 0.5F), (double)((float)par3 + 0.5F), (double)((float)par4 + 0.5));
                    par1World.spawnEntityInWorld(entitytntprimed);
                    par1World.playSoundAtEntity(entitytntprimed, "random.fuse", 0.0F, 0.0F);
            	}*/
        		IPrime entitytntprimed = new IPrime(par1World, (double)((float)par2 + 0.5F), (double)((float)par3 + 0.5F), (double)((float)par4 + 0.5), Main.fuseLen);
                par1World.spawnEntityInWorld(entitytntprimed);
...
/*    public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(texturePath + textureName + "_side");
        this.field_150116_a = p_149651_1_.registerIcon(texturePath+textureName + "_top");
        this.field_150115_b = p_149651_1_.registerIcon(texturePath + textureName + "_bottom");
    }
}
