package com.cat40.bombrange.blocks.c4.minecraft;
...
public class C4_Mine extends Block
{
    private String texturePath = Main.modid;  
    private int thisBlockID;
    
    public C4_Mine (int id, Material blockMaterial, String textureName) {
    ...
    public void onBlockDestroyedByExplosion(World par1World, int par2, int par3, int par4, Explosion par5Explosion)
    {
        ...
        {
            MinePrime entitytntprimed = new MinePrime(par1World, (double)((float)par2 + 0.5F), (double)((float)par3 + 0.5F), (double)((float)par4 + 0.5F), par5Explosion.getExplosivePlacedBy());
    ...
    public void primeTnt(World par1World, int par2, int par3, int par4, int par5, EntityLivingBase par6EntityLivingBase)
    {
        if (!par1World.isRemote)
        {
            if ((par5 & 1) == 1)
            {
                MinePrime entitytntprimed = new MinePrime(par1World, (double)((float)par2 + 0.5F), (double)((float)par3 + 0.5F), (double)((float)par4 + 0.5F), par6EntityLivingBase);
                par1World.spawnEntityInWorld(entitytntprimed);
