...
public class FirePrime extends Entity
{
    ...
    public FirePrime(World par1World)
    {
        super(par1World);
    ...
    public FirePrime(World par1World, double par2, double par4, double par6)//EntityLivingBase par8EntityLivingBase
    {
        this(par1World);
        ...
        if (this.fuse-- <= 0)
        {
            ...
            if (!this.worldObj.isRemote)
            {
            	...
            	for(i=0; i<this.rings; i++)
                {
            		...
            		{
	            		EntitySmallFireball entitylargefireball = new EntitySmallFireball(this.worldObj);
