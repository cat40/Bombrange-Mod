...
public class BombRangeGenLayerBiome extends GenLayer
{
    private List<BiomeEntry>[] biomes = new ArrayList[BiomeManager.BiomeType.values().length];
    
    private static final String __OBFID = "CL_00000555";

    public BombRangeGenLayerBiome(long p_i2122_1_, GenLayer p_i2122_3_, WorldType p_i2122_4_)
    {
        super(p_i2122_1_);
        ...
        for (BiomeManager.BiomeType type : BiomeManager.BiomeType.values())
        {
           ...
           // if (biomesToAdd != null) biomes[idx].addAll(BiomeRegistry.BombRange);
        }
        ...
        if (p_i2122_4_ == WorldType.DEFAULT_1_1)
        {
          /*  biomes[desertIdx].add(new BiomeEntry(BiomeGenBase.desert, 10));
            ...
            biomes[desertIdx].add(new BiomeEntry(BiomeRegistry.BombRange, 10));
        }
        else
        {
