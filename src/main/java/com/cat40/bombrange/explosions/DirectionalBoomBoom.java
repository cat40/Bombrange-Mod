...
public class DirectionalBoomBoom extends Explosion {

    private World worldObj;
    private int field_77289_h = 16;

    public DirectionalBoomBoom(World world, double x, double y, double z, float power)
    {
        this(world, null, x, y, z, power);
    }

    public DirectionalBoomBoom(World world, Entity entity, double x, double y, double z, float power)
    {
