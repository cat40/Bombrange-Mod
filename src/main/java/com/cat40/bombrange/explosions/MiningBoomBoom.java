...
public class MiningBoomBoom extends Explosion {

    private World worldObj;
    private static Random explosionRNG = new Random();
    private int field_77289_h = 16;
    private static List<Block> badBlocks = new ArrayList<Block>() {{
        add(Blocks.dirt);
        add(Blocks.stone);
    ...
    public MiningBoomBoom(World world, double x, double y, double z, float power)
    {
        this(world, null, x, y, z, power);
    }

    public MiningBoomBoom(World world, Entity entity, double x, double y, double z, float power)
    {
